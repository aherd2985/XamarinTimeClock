...
{
  /// <summary>
  /// This provides an easy way to encrypt and decrypt data using a simple password.
  /// </summary>
  /// <remarks>
  ...
  static internal class Crypto
  {
    ...
    private static readonly byte[] salt = Encoding.ASCII.GetBytes("MadFatLazyCatSleeps8Night4N0$");
